      ...
      <div style={{position:'relative',width:200,height:250,display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column'}}>
        <div style={{width:200,height:210,borderRadius:80,display:'flex',flexDirection:'column',zIndex:800}}>
          <div style={{display:'flex',justifyContent:'center'}}>
            <div style={{width:35,height:35,backgroundColor:'#dcdcdc',borderRadius:'70px 150px 70px 500px',zIndex:1000,transform:'rotate(-60deg)'}}>
            ...
            <div style={{width:65,height:70,marginTop:-15,marginLeft:-10,backgroundColor:'#fff',border:'5px solid #dcdcdc',boxSizing:'border-box',borderRadius:50,transform:'rotate(-60deg)'}}/>
            <div style={{width:65,height:70,marginTop:-15,marginLeft:-10,backgroundColor:'#fff',border:'5px solid #dcdcdc',boxSizing:'border-box',borderRadius:50,transform:'rotate(60deg)'}}/>
            <div style={{width:35,height:35,marginLeft:-10,backgroundColor:'#dcdcdc',borderRadius:'70px 150px 70px 500px',zIndex:1000,transform:'rotate(-20deg)'}}>
              <div style={{width:30,height:30,marginTop:5,alignItems:'center',justifyContent:'center',display:'flex',backgroundColor:'#fff',borderRadius:'70px 150px 70px 500px'}}>
                <div style={{width:15,height:15,backgroundColor:'#FFD8D8',borderRadius:'70px 150px 70px 500px'}}/>
              </div>
            </div>
          ...
          <div style={{display:'flex',marginTop:-35}}>
            <div style={{minWidth:100,backgroundColor:'#fff',border:'5px solid #dcdcdc',boxSizing:'border-box',height:100,borderRadius:50,marginLeft:-15}}/>
            <div style={{minWidth:100,backgroundColor:'#fff',border:'5px solid #dcdcdc',boxSizing:'border-box',height:100,borderRadius:50,marginLeft:30}}/>
          </div>
          <div style={{display:'flex',marginTop:-35}}>
            <div style={{minWidth:100,backgroundColor:'#fff',border:'5px solid #dcdcdc',boxSizing:'border-box',height:95,borderRadius:50,marginLeft:-15}}/>
            <div style={{minWidth:100,backgroundColor:'#fff',border:'5px solid #dcdcdc',boxSizing:'border-box',height:95,borderRadius:50,marginLeft:30}}/>
          </div>
